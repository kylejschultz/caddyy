...
import { Tv, Folder, HardDrive, Settings as SettingsIcon } from 'lucide-react'
...
export default function ShowsSettings() {
  const [settings, setSettings] = useState<ShowSettings>({
    paths: {
      ...
      downloads: '/downloads/tv-shows',
      completed: '/downloads/completed/tv-shows'
    },
    quality: {
  ...
  return (
    <div className="p-6 max-w-4xl">
      <div className="flex items-center space-x-3 mb-6">
        ...
        <h1 className="text-2xl font-bold text-white">TV Show Settings</h1>
      </div>
        ...
        <div className="bg-slate-800 rounded-lg p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                type="text"
                value={settings.paths.shows}
                onChange={(e) => setSettings(prev => ({
                  ...prev,
                  paths: { ...prev.paths, shows: e.target.value }
                }))}
        ...
        <div className="bg-slate-800 rounded-lg p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                type="text"
                value={settings.naming.seasonFormat}
                onChange={(e) => setSettings(prev => ({
                  ...prev,
                  naming: { ...prev.naming, seasonFormat: e.target.value }
                }))}
                className="w-full px-3 py-2 bg-slate-700 border border-slate-600 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
